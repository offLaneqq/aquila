    ...
    <main id="main" class="site-main mt-5" role="main">
        <aquila-search class="aquila-search row px-4">
            <aquila-filters class="col-lg-3 col-md-3 col-sm-12 pb-4">
                <aquila-clear-all-filters class="clear-all-filters"><button class="btn btn-secondary">Clear All
                        filters</button></aquila-clear-all-filters>
                <?php foreach ($filters_data as $filter_data): ?>
                    <aquila-checkbox-accordion class="checkbox-accordion"
                        ...
                        <?php if (!empty($filter_data['label'])): ?>
                            <div class="checkbox-accordion__handle" role="button">
                                <div class="checkbox-accordion__handle-text">
                                    <?php echo esc_html($filter_data['label']); ?>
                                </div>
                                    ...
                                    <aquila-checkbox-accordion-child
                                        ...
                                        <div class="checkbox-accordion__child-handle form-field">
                                            <label data-text="<?php echo esc_attr($item['label']); ?>" class="checkbox">
                                                <input data-text="<?php echo esc_attr($item['label']); ?>" type="checkbox"
                                                    data-key="<?php echo esc_attr($filter_data['slug'] ?? ''); ?>"
                                                    value="<?php echo esc_attr($item['value']); ?>" <?php if (!empty($has_children)): ?> data-has-children="true" <?php endif; ?>>
                                                <span data-text="<?php echo esc_attr($item['label']); ?>" class="checkbox-text">
                                                        ...
                                                        <aquila-checkbox-accordion-child class="checkbox-accordion__child">
                                                            <div class="checkbox-accordion__child-handle form-field">
                                                                <label data-text="<?php echo esc_attr($child['label']); ?>" class="checkbox">
                                                                    <input data-key="<?php echo esc_attr($filter_data['slug'] ?? ''); ?>"
                                                                        data-text="<?php echo esc_attr($child['label']); ?>"
                                                                        data-parents="<?php echo esc_attr($item['value']); ?>" <?php if (!empty($has_grand_children)): ?> data-has-children="true" <?php endif; ?> type="checkbox"
                                                                    ...
                                                                    <?php foreach ($child['children'] as $grand_children): ?>
                                                                        ...
                                                                        <?php if (!empty($grand_children['label']) && !empty($grand_children['value'])): ?>
                                                                            <aquila-checkbox-accordion-child
                                                                                class="checkbox-accordion__child <?php echo esc_attr($has_content_class); ?>">
                                                                                <div class="checkbox-accordion__child-handle form-field">
                                                                                    <label data-text="<?php echo esc_attr($grand_children['label']); ?>"
                                                                                        class="checkbox">
                                                                                        <input
                                                                                            data-key="<?php echo esc_attr($filter_data['slug'] ?? ''); ?>"
                                                                                        ...
                                                                                        <span
                                                                                            data-text="<?php echo esc_attr($grand_children['label']); ?>"
                                                                                            class="checkbox-text">
                                                                                            <?php echo wp_kses_post($grand_children['label']); ?>
                                                                                        </span>
                                                                                    </label>
                                                                                    <?php if (!empty($has_great_grand_children)): ?>
                                                                                        <span data-text="<?php echo esc_attr($grand_children['label']); ?>"
                                                                                            class="checkbox-accordion__child-handle-icon"></span>
                                                                                    <?php endif; ?>
                                                                                </div>
                                                                                <?php if (!empty($has_great_grand_children)): ?>
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <label
                                                                                                        ...
                                                                                                        <span
                                                                                                            data-text="<?php echo esc_attr($great_grand_children['label']); ?>"
                                                                                                            class="checkbox-text">
                                                                                                            <?php echo wp_kses_post($great_grand_children['label']); ?>
                                                                                                        </span>
                                                                                                    </label>
                                                                                                </div>
                                                                                            <?php endif; ?>
